function info = get_computer_information()

% Get the computer architecture
info.computer_architecture = computer('arch');
info.operating_system = getenv('OS');
cpu_info = cpuinfo();
info.cpuname = cpu_info.Name;
info.clock   = cpu_info.Clock;
info.cache   = cpu_info.Cache;
info.Nprocessors = cpu_info.NumProcessors;
info.OSType = cpu_info.OSType;
info.OSVersion = cpu_info.OSVersion;
