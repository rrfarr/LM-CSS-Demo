function Ys = AGNN_X_v01_RR_SR(Xs, SR_config)
% The AGNN_X_v01_RR_SR super-resolution method tries to find the closest
% neighbours by exploiting the geometric structure of the manifold modelled
% by the weighted graph W. The resulting neighbourhood of samples will be 
% used to infer the high resolution patch using Ridge Regression.
%
...
for p = 1:P
    ...
    % Derive the weighted graph corresponding to this patch
    W_L = SR_config.sub_dict_data{p}.W;
